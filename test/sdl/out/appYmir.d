...
Tuple!(ulong, char*) _Y3app18sliceNGubyteGU3U5NFZcs () {
    return _Y3app100CstStringFZv (2, ("et").ptr);
}

Tuple!(ulong, char*) _Y3app18sliceNGubyteGU2U5NFZcs () {
    return _Y3app100CstStringFZv (3, ("ety").ptr);
}

Tuple!(ulong, char*) _Y3app18sliceNGubyteGU1U5NFZcs () {
    return _Y3app100CstStringFZv (4, ("etyb").ptr);
}

Tuple!(ulong, char*) _Y3app18sliceNGubyteGU0U5NFZcs () {
    return _Y3app100CstStringFZv (5, ("etybu").ptr);
}
...
Tuple!(ulong, char*) _Y3app5toNsNFbdZs ( byte elem) {
     ...
     Tuple!(ulong, char*) ret = tuple (cast (ulong) (2U), (cast (char*) GC.calloc ((char).sizeof * cast (ulong) (2U))));
...
Tuple!(ulong, char*) _Y3app16sliceNGintGU2U5NFZcs () {
    return _Y3app100CstStringFZv (1, ("t").ptr);
}

Tuple!(ulong, char*) _Y3app16sliceNGintGU1U5NFZcs () {
    return _Y3app100CstStringFZv (2, ("tn").ptr);
}

Tuple!(ulong, char*) _Y3app16sliceNGintGU0U5NFZcs () {
    return _Y3app100CstStringFZv (3, ("tni").ptr);
}
...
Tuple!(ulong, char*) _Y3app5toNsNFiZs ( int elem) {
    if (cast (bool) (elem < cast (int) (0))) {
        return _Y4core6string14opBinaryNG43GNFcscsZs (_Y3app100CstStringFZv (1, ("-").ptr), _Y3app5toNsNFiZs ((-elem)));
    } else if (cast (bool) (elem == cast (int) (0))) {
        return _Y3app100CstStringFZv (1, ("0").ptr);
    }
     int nb = elem;
    ...
    while (cast (bool) (nb > cast (int) (0)))  {
     ...
     Tuple!(ulong, char*) res = tuple (size, (cast (char*) GC.calloc ((char).sizeof * size)));
...
Tuple!(ulong, char*) _Y3app12addTupleComaFiubZs ( int left,  ubyte elem) {
     {
        return _Y4core6string14opBinaryNG43GNFcscsZs (_Y4core6string14opBinaryNG43GNFcscsZs (_Y3app5toNsNFiZs (left), _Y3app100CstStringFZv (2, (", ").ptr)), _Y3app12addTupleComaFubZs (elem));
    }
}
...
Tuple!(ulong, char*) _Y3app5toNsNFTiubZs ( Tuple!(int, ubyte) elem) {
    ...
    return _Y4core6string14opBinaryNG43GNFcsaZcs (_Y4core6string14opBinaryNG43GNFcscsZs (_Y3app100CstStringFZv (6, ("tuple(").ptr), _Y3app12addTupleComaFiubZs (__0__ [0], __0__ [1])), cast (char) (41));
}

void _Y3app5printFTiubZv ( Tuple!(int, ubyte) a) {
    _Y4core5stdio5printFcsZv (_Y3app100CstStringFZv (1, ("(").ptr));
...
Tuple!(ulong, void function(Tuple!(int, ubyte))*) _Y3app14opBinaryNG43GNFAf_TiubAf_TiubZAf_Tiub ( Tuple!(ulong, void function(Tuple!(int, ubyte))*) a,  Tuple!(ulong, void function(Tuple!(int, ubyte))*) b) {
     Tuple!(ulong, void function(Tuple!(int, ubyte))*) c = tuple (cast (ulong) (a [0] + b [0]), (cast (void function(Tuple!(int, ubyte))*) GC.calloc ((void function(Tuple!(int, ubyte))).sizeof * cast (ulong) (a [0] + b [0]))));
...
void _Y3app7connectFR26STSignal33NtupleNintU32ubyteNNf_TiubZv ( ST5inputSignal33NtupleNintU32ubyteNN ** sig,  void function(Tuple!(int, ubyte)) fun) {
    if (cast (bool) ((*sig) is null)) {
        (*sig) = new ST5inputSignal33NtupleNintU32ubyteNN ();
    }
    _Y3app7printlnFbZv (cast (bool) (((*sig)).sig [1] is null));
    if (cast (bool) (((*sig)).sig [1] is null)) {
         void function(Tuple!(int, ubyte))* __0__ = (cast (void function(Tuple!(int, ubyte))*) GC.calloc (1 * 8U));

        __0__ [0] = fun;
        ((*sig)).sig = tuple (cast (ulong) (1), __0__);
    } else  {
         void function(Tuple!(int, ubyte))* __1__ = (cast (void function(Tuple!(int, ubyte))*) GC.calloc (1 * 8U));
...
Tuple!(ulong, void function(Tuple!(ubyte, int, int, ubyte))*) _Y3app14opBinaryNG43GNFAf_TubiiubAf_TubiiubZAf_Tubiiub ( Tuple!(ulong, void function(Tuple!(ubyte, int, int, ubyte))*) a,  Tuple!(ulong, void function(Tuple!(ubyte, int, int, ubyte))*) b) {
     Tuple!(ulong, void function(Tuple!(ubyte, int, int, ubyte))*) c = tuple (cast (ulong) (a [0] + b [0]), (cast (void function(Tuple!(ubyte, int, int, ubyte))*) GC.calloc ((void function(Tuple!(ubyte, int, int, ubyte))).sizeof * cast (ulong) (a [0] + b [0]))));
...
void _Y3app7connectFR38STSignal33NtupleNubyteU32intU32intU32ubyteNNf_TubiiubZv ( ST5inputSignal33NtupleNubyteU32intU32intU32ubyteNN ** sig,  void function(Tuple!(ubyte, int, int, ubyte)) fun) {
    if (cast (bool) ((*sig) is null)) {
        (*sig) = new ST5inputSignal33NtupleNubyteU32intU32intU32ubyteNN ();
    }
    _Y3app7printlnFbZv (cast (bool) (((*sig)).sig [1] is null));
    if (cast (bool) (((*sig)).sig [1] is null)) {
         void function(Tuple!(ubyte, int, int, ubyte))* __0__ = (cast (void function(Tuple!(ubyte, int, int, ubyte))*) GC.calloc (1 * 8U));

        __0__ [0] = fun;
        ((*sig)).sig = tuple (cast (ulong) (1), __0__);
    } else  {
         void function(Tuple!(ubyte, int, int, ubyte))* __1__ = (cast (void function(Tuple!(ubyte, int, int, ubyte))*) GC.calloc (1 * 8U));
...
Tuple!(ulong, void function(Tuple!())*) _Y3app14opBinaryNG43GNFAf_TAf_TZAf_T ( Tuple!(ulong, void function(Tuple!())*) a,  Tuple!(ulong, void function(Tuple!())*) b) {
     Tuple!(ulong, void function(Tuple!())*) c = tuple (cast (ulong) (a [0] + b [0]), (cast (void function(Tuple!())*) GC.calloc ((void function(Tuple!())).sizeof * cast (ulong) (a [0] + b [0]))));
...
void _Y3app7connectFR16STSignal33NtupleNNNf_TZv ( ST5inputSignal33NtupleNNN ** sig,  void function(Tuple!()) fun) {
    if (cast (bool) ((*sig) is null)) {
        (*sig) = new ST5inputSignal33NtupleNNN ();
    }
    _Y3app7printlnFbZv (cast (bool) (((*sig)).sig [1] is null));
    if (cast (bool) (((*sig)).sig [1] is null)) {
         void function(Tuple!())* __0__ = (cast (void function(Tuple!())*) GC.calloc (1 * 8U));

        __0__ [0] = fun;
        ((*sig)).sig = tuple (cast (ulong) (1), __0__);
    } else  {
         void function(Tuple!())* __1__ = (cast (void function(Tuple!())*) GC.calloc (1 * 8U));
...
void main () {
    ...
    _Y3app7connectFR16STSignal33NtupleNNNf_TZv (_Y5input4quitFZR16STSignal33NtupleNNN (), (&_Y3app4QuitFTZv));
     ST3sdlWindow * win = _Y3sdl7initSDLFcsiiZ6STWindow (_Y3app100CstStringFZv (4, ("Test").ptr), cast (int) (800), cast (int) (600));
...
Tuple!(ulong, char*) _Y3app100CstStringFZv ( ulong len,  const (char)* ptr) {
     ulong __0__ = 0;
     char* __1__ = (cast (char*) GC.calloc (len));
    ...
    return tuple (cast (ulong) (__0__), __1__);
}
